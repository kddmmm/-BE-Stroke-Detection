...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            if face_result_obj["Result"] == "failed to detect face" or face_result_obj["Result"] == "no front face":
                continue
            
            if face_result_obj["Result"] == "normal":
                #await asyncio.sleep(300)
                continue
            elif face_result_obj["Result"] == "abnormal":
                ...
                final_value = 0.5 * arm_result_obj["rate"] + 0.3 * face_result_obj["rate"] + 0.2 * voice_result_obj["rate"]
                if final_value < 0.5:
                    await websocket.send_text(json.dumps({
                        "type": "final",
                        "value": "normal",
                ...
                write_result(face_result_obj, arm_result_obj, voice_result_obj, final_value)
